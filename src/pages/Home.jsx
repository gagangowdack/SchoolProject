        ...
        <section className="values-section">
          ...
          <div className="values-grid">
            ...
            <div className="value-card">
              <div className="value-icon">🎓</div>
              <h3>Excellence</h3>
              <p>We pursue excellence — academically, creatively and in character — in all we do.</p>
            </div>
          </div>
        </section>
        ...
        <section className="events-section">
          ...
          <div className="events-grid">
            <article className="event-card">
              ...
              <p>Admissions for the new academic year are now open. Enrollments are limited — apply early.</p>
            ...
            <article className="event-card">
              ...
              <p>Student projects on display — join us to celebrate creativity and inquiry.</p>
